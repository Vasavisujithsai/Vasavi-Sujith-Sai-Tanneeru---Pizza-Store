...
public class Comments {
	...
	private long comments_user_id;
	private long comments_product_id;
	
	public Comments(long comments_product_id) {
		super();
		this.comments_product_id = comments_product_id;
	}
	public long getComments_product_id() {
		return comments_product_id;
	}
	public void setComments_product_id(long comments_product_id) {
		this.comments_product_id = comments_product_id;
	}
	...
	public long getComments_user_id() {
		return comments_user_id;
	}
	public void setComments_user_id(long comments_user_id) {
	...
	public Comments(long comments_id, long comments_user_id, String comments_title, String comments_description,
