...
import com.project.onlinepizzaorderingsystem.model.Category;
import com.project.onlinepizzaorderingsystem.model.Company;
import com.project.onlinepizzaorderingsystem.model.Country;
import com.project.onlinepizzaorderingsystem.model.Product;
import com.project.onlinepizzaorderingsystem.model.Sell;
import com.project.onlinepizzaorderingsystem.model.State;
import com.project.onlinepizzaorderingsystem.repository.SellRepository;
	...
	public ArrayList getAllEmployeeFields(@PathVariable(value = "id") Long orderId) {
		 ...
		 for ( Object[] row : sell ) {
			  ...
			  HashMap<String, String> results = new HashMap();
			    ...
			    results.put("sell_order_id",String.valueOf(sell_details.getSell_order_id()));
			    results.put("sell_product_id",String.valueOf(sell_details.getSell_product_id()));
