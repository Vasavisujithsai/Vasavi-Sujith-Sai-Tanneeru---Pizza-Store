...
public class Login {
	...
	private long login_employee_id;
	...
	public long getLogin_employee_id() {
		return login_employee_id;
	}

	public void setLogin_employee_id(long login_employee_id) {
	...
	public Login(long login_id, long login_employee_id, String login_email, String login_password,
