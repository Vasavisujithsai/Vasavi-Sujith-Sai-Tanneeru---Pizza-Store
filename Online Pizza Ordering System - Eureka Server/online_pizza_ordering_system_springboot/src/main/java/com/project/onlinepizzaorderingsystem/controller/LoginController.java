...
import com.project.onlinepizzaorderingsystem.repository.LoginRepository;
		 ...
		 for ( Object[] row : login ) {
			 ...
			 HashMap<String, String> results = new HashMap();
			  ...
			  Employee employee_details = (Employee)row[ 0 ];
				...
				results.put("login_employee_id",String.valueOf(login_details.getLogin_employee_id()));
