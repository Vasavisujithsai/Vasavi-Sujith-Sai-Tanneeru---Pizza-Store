...
public class Sell {
	...
	public long getSell_product_id() {
		return sell_product_id;
	}

	public void setSell_product_id(long sell_product_id) {
	...
	public Sell(long sell_id, long sell_order_id, long sell_product_id, String sell_units,
